...
Feature: Update Tiers in BD Opportunities
  ...
  @Positive @Run #TC-4239, TC-3808, TC-3822, TC-3823, TC-4241
  Scenario Outline: Validate Tier Values Combination <t4> (<num>)
    ...
    |yfSAAT|56 |DTS / MSC in Data Analytics        |Public Non-Apps  |PQ (FS)                              |IOC                                                              |3 |2 |6 |
    ...
    |zQ8AAL|142|Other Technology Products          |Public Non-Apps  |                                     |                                                                 |8 |1 |1 |
