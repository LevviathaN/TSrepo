...
Feature: BPP University Hub Sub Topics and Labels
  ...
  Scenario: Hub Sub Topics and Labels_Mobile
    ...
    And I wait for "3" seconds
    Given I execute "Login as Admin Totara" reusable step if "Totara You Are not Logged In" "element is present"
    Given I execute "Login as Admin Totara" reusable step if "Totara Login" "element is present"
    #Enrol To course for ICAEW Course
    When I click on the "Totara VPE Course Automation link" link by JS
