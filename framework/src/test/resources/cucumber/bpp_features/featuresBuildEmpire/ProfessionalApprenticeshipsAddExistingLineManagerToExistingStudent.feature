...
Feature: Professional Apprenticeships
  ...
  Scenario: Create Professional Apprenticeships Add Existing Line Manager To Existing Student
    Given I execute "Log In to Hub as Student" reusable step replacing some steps
      | 2 | I set "AutoFrankieSammie4358@harakirimail.com" text to the "Email" "Build Empire text field" |
      | 3 | I set "A@polloGlobal2020" text to the "Password" "Build Empire text field"               |
    Then I remember "AutoCompton" text as "EC_AUTO_LASTNAME" variable
    ...
    And I execute "Pre Approve Apprenticeships Application As Admin" reusable step replacing some steps
      | 4 | I fill the "Direct App Admin Filter By User" field with "AutoFrankieSammie4358@harakirimail.com" |
