    ...
    public static String getExecutionContextValueByKey(String key) {
        ...
        if (executionContext.getValues().containsKey(key)) {
            ...
            reporter.info("Requested " + key + " execution context key is absent.\n\t\tPossible reasons are:\n" +
                    ...
                    "\t\t- the requested key is misspelled in the excel spreadsheet located in the " + /** todo: hardcoded path */ "src/main/resources/data/bpp/input" + "/ folder path.");
            ...
            reporter.info("Requested " + key + " execution context key is absent.<pre>Possible reasons are:<br>" +
                    ...
                    "- the requested key is misspelled in the excel spreadsheet located in the " + /** todo: hardcoded path */ "src/main/resources/data/bpp/input" + "/ folder path.</pre>");
