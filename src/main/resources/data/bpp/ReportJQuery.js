$(document).ready(function(){
        ...
        /*setting a new name for the log link*/
 		...
 		/*assign icons to category labels on each separate test*/
 			$('.category-list>span.category>span:contains("Tag")').parent().prepend('<i class="material-icons category-labels">title</i>');
 			$('.category-list>span.category>span:contains("Sheet")').parent().prepend('<i class="material-icons category-labels">library_books</i>');
 		...
 		/*assign icons to categories in "Category" dropdown*/
 			...
 			$('#category-toggle>li>a:contains("Sheet")').prepend('<i class="material-icons category-labels">library_books</i>');
 		...
 		/*remove excessive categories on the "Categories" and "Dashboard" tab*/
 			$('#category-collection>li.category>div.category-heading>span.category-name>a:contains(".log")').parents('li').remove();
