...
public enum StepPatterns {
    ...
    I_SHOULD_SCROLL_TO_THE_TOP_BOTTOM_OF_THE_PAGE("^I should scroll to the \"(top|bottom)\" of the page$"),
    ...
    I_GENERATE_DATE_AND_TIME_AS_TEXT_PATTERN("^I generate date and time as text pattern \"([^\"]*)\" to \"([^\"]*)\" variable$");
