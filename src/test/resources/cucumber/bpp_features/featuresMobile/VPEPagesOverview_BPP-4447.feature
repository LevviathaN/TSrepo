...
Feature: The Hub - Law School - Pages - Overview
  ...
  Scenario: The Hub - Law School - Pages - Overview_Mobile
    ...
    #And I click on the "Hub VPE Mobile Samsung Hamburger Menu" element if "Hub VPE Mobile Samsung Hamburger Menu" "element is present"
    #And I click on the "Hub VPE Mobile My Learning Header" button if "Hub VPE Mobile My Learning Header" "element is present"
    #And I click on the "Hub VPE Mobile Samsung My Learning Header" element if "Hub VPE Mobile Samsung My Learning Header" "element is present"
    #And I click on the "Hub VPE Mobile My Learning Course Automation" element
