...
Feature: The Hub - Law School - Documents (Files/Labels activity type)
  ...
  Scenario: The Hub - Law School - Documents_Mobile
    ...
    And I click on the "Hub VPE Mobile Samsung My Learning Header" button if "Hub VPE Mobile Samsung My Learning Header" "element is present"
